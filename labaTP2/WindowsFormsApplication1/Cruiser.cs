...
namespace WindowsFormsApplication1
{
    class Cruiser : Ship
    {
        ...
        public Cruiser(int maxSpeed, int maxCrew, double displacement, Color mainC, bool frontCannon, bool backCannon, Color dopC, Color secondC) : base(maxSpeed, maxCrew, displacement, mainC, secondC)
        {
